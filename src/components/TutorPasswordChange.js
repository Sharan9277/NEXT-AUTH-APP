    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-4 md:p-6">
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-3">
                <div>
                    <label className="block text-gray-700 mb-1 text-sm font-medium">Current Password</label>
                    <input 
                        type="password" 
                ...
                <button 
                    type="submit"
                    className="w-full p-2 rounded text-white bg-blue-500 hover:bg-blue-600 mt-4"
                    disabled={loading}
                >
