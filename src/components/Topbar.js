...
const Topbar = () => {
  ...
  const studentId = session?.user?.id || "default"; // Get tutor ID from session
  ...
  return (
    <div className="w-full sticky bg-[#fff] border-[#7f7f7f] border-solid border-t-[1px] border-b-[1px]  flex flex-col items-start justify-start py-[0px] px-[45px] top-[0] z-[99] leading-[normal] tracking-[normal] mq719:pl-[22px] mq719:pr-[22px] mq719:box-border">
