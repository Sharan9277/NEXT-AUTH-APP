    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-6 p-4 md:p-6">
        ...
        <div className="flex-1 bg-white shadow-md rounded-lg p-4 md:p-6">
          <h1 className="text-xl md:text-2xl font-bold font-inter text-black mb-4">Admin Dashboard</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
              <div className="bg-gray-50 shadow-md p-4 rounded-lg flex flex-col items-center">
                ...
                <PieChart width={250} height={250}>
                  <Pie data={combinedData} cx="50%" cy="50%" outerRadius={80} fill="#8884d8" dataKey="value">
