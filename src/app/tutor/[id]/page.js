...
export default function TutorProfile() {
  ...
  return (
    <div className="container mx-auto flex flex-col md:flex-row gap-6 p-6">
      {/* Left Column (Fixed) */}
      <div className="w-full md:w-3/5 bg-white p-6 shadow-lg rounded-lg">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="text-yellow-500 text-lg">⭐ {tutor.rating || "N/A"} / 5</span>
              {tutor.isVerified && (
      ...
      {/* Right Column (Fixed) */}
      <div className="w-full md:w-2/5 sticky top-6 self-start">
        <div className="p-6 bg-white shadow-lg rounded-lg">
          <h2 className="text-xl font-semibold text-center">Tutor Details</h2>
          <p className="text-center text-gray-600">⭐ Overall Rating: {tutor.rating || "N/A"}</p>
